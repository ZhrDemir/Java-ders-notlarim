...
import day13_arrays.C06_Arrays_soru4;

import java.util.Arrays;

public class C05_Binary {
    public static void main(String[] args) {
        int[] arr = {3,6,1,8,2,9,12,-1,4,3};

        // arr'de 5'in olup olmadigini ve varsa kac tane oldugunu yazdirin
      C06_Arrays_soru4.elemanSayisiYazdir(arr,5); // Aranan eleman array'de yok

        // arr'de 3'in olup olmadigini ve varsa kac tane oldugunu yazdirin
        C06_Arrays_soru4.elemanSayisiYazdir(arr,3); // Aranan eleman array'de 2 kere kullanilmis
